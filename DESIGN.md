...
| 7 | 场景变化记忆 | ✅ 已实现 | 物体列表提取 + 帧间 diff 对比 + 事件日志 + 自然语言查询 |
| 8 | AI 主动观察提示 | ✅ 已实现 | 5 条可配置触发规则（新人/书本/错误/文字/场景变化）+ 冷却机制 |
| 9 | OCR 文字识别 | ✅ 已实现 | 基于视觉模型的纯 OCR，支持提取/总结/翻译三种模式 |
| 10 | 跨模态长期记忆 | ✅ 已实现 | 统一视觉+OCR+语音历史，支持时间窗口检索和模态偏好推断 |
